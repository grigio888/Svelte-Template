<script>
	...
	import { generateSlug } from '$comp/modules/utils.js';
...
<svelte:head>
	...
	<title>{PUBLIC_APP_NAME}{title ? ' - ' + title : ''}</title>
	...
	<meta property="og:title" content="{PUBLIC_APP_NAME}{title ? ' - ' + title : ''}" />
	...
	<meta name="twitter:title" content="{PUBLIC_APP_NAME}{title ? ' - ' + title : ''}" />
